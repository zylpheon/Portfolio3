...
function showSkillModal(skill) {
  ...
  const skillData = {
    frontend: {
      ...
      description: 'Specialized in creating responsive and interactive user interfaces using modern web technologies. Experienced in building dynamic web applications with clean, semantic code and optimal user experience across all devices.',
      icons: ['HTML5', 'CSS3', 'Bootstrap', 'Tailwind', 'JavaScript', 'jQuery']
    },
    backend: {
      title: 'Backend Development',
      description: 'Skilled in server-side development and database management. Proficient in building scalable APIs, handling data processing, and implementing secure authentication systems for robust web applications.',
      icons: ['Node.js', 'PHP', 'Python', 'MySQL', 'MongoDB', 'Express']
    },
    iot: {
      title: 'IoT Development',
      description: 'Experienced in Internet of Things development including sensor integration, microcontroller programming, and creating connected devices that communicate with cloud platforms and mobile applications.',
      icons: ['Arduino', 'ESP32', 'Raspberry Pi', 'MQTT', 'Sensors', 'C++']
    },
    linux: {
      title: 'Linux Management',
      description: 'Proficient in Linux system administration, server configuration, and shell scripting. Experienced in managing web servers, implementing security measures, and optimizing system performance.',
      icons: ['Ubuntu', 'CentOS', 'Bash', 'SSH', 'Apache', 'Nginx']
    },
    network: {
      title: 'Network Administration',
      description: 'Skilled in network configuration, troubleshooting, and security implementation. Experienced with routing protocols, firewall setup, and maintaining reliable network infrastructure for organizations.',
      icons: ['Cisco', 'Router', 'Switch', 'Firewall', 'VPN', 'TCP/IP']
    },
    project: {
      title: 'Project Management',
      description: 'Experienced in leading development projects from conception to deployment. Proficient in agile methodologies, team coordination, and ensuring timely delivery of high-quality software solutions.',
      icons: ['Scrum', 'Agile', 'Git', 'Jira', 'Trello', 'Slack']
    }
  };
  ...
  icons.innerHTML = data.icons.map(icon =>
    `<span class="px-3 py-2 bg-blue-500 text-white text-sm rounded-full">${icon}</span>`
  ).join('');
